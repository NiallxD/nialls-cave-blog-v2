...
So often in my day to day life I run into people/opinions which fall foul of the same errors. Often these concern politics, but other areas are impacted too, such as the way in which people drive their cars, the way they choose to purchase goods in the supermarket...even the supermarket they choose to shop at. It seems everywhere you look people are making decisions based on a fundamentally erroneous view of the world around them.

The crux of the issue are this, humans struggle to understand, or appreciate, the complexity of the things around them. They form a mental model of a particular issue based on a tip-of-the-iceberg understanding of the problem, and then make decisions on how to act. This often leads to decisions been made which are incorrect, sub-optimal, or just not what the person really wanted.
...
So in the above example, when someone experiences Inattention Blindness, errors are made because their senses didn't gather enough information to form a true representation of the world infront of them. There is another level to this in that the person had mental models in their brain which were used to convert the limited information provided into a view of the world with which decisions could be made.

An example could be this, a person walks past their dining room table every day to get to the door, the table is kept tidy and clean. One day, in a rush to leave for an appointment, the person walks past the table to the door before realising they haven't picked up the car keys. They rush back into the house, past the table, and start frantically looking for the keys, to no avail. They walk back into the kitchen to see the car keys sat their in plain sight on the table...how did they miss them twice?
...
[This video on the topic is worth a watch](https://www.youtube.com/watch?v=vJG698U2Mvo)
